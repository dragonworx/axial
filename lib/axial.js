module.exports = (function Define_Axial () {
  ...
  class AxialInstanceProxy {
    ...
    dock (parentInstance, property) {
      if (typeof parentInstance.onChildDocking === 'function') {
        const dockError = parentInstance.onChildDocking(this._instance, property);
      ...
      const oldParentInstance = this._parentInstance;
      this._parentInstance = parentInstance;
      ...
      const event = {
        ...
        preserveParent: () => {
          this._parentInstance = oldParentInstance;
        }
      };
