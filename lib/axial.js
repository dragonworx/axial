module.exports = (function Define_Axial () {
  ...
  class AxialInterface extends AxialObject {
    ...
    create (defaultValues = {}, container) {
      // create instance
      const instance = new AxialInstance(this, container);
  ...
  class AxialInstance {
    ...
    dock (container, property) {
      if (typeof container.onChildDocking === 'function') {
        const dockError = container.onChildDocking(this, property);
    ...
    lock () {
      ...
      this._watchIntervalId = setInterval(() => {
        for (let key in this) {
          if (this.hasOwnProperty(key) && !_isValidKey(key) && !props.has(key)) {
