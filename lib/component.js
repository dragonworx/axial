import { getObjectAtPath, getTypeOfProperty, isObjectLiteral, getObjectKeys, isReservedKey } from './util';
...
class AxialComponent extends React.Component {
  // TODO: should we be pushing every Axial.axis or only when props or static constructor passed? yes.
  constructor (props) {
    super(props);
    ...
    if (props && props.hasOwnProperty('axis')) {
      axis = props.axis;
    }
    ...
    this.componentWillUnmount = () => {
      if (this.props.hasOwnProperty('axis')) {
        pop();
      }
